...
// import type { ChatGPTMessage } from "@/types"; // Remove if unused
...
export const initialMessages: UIMessage[] = [
  {
    ...
    parts: [
      {
        type: "text",
        text: "Hi! I am your PDF assistant. I am happy to help with your questions about your PDF about German law.",
      },
    ],
  },
];
